...
public class UserDialog extends Popover {
    ...
    public UserDialog(AuthenticationContext authContext) {
        ...
        UnorderedList list = new UnorderedList(
                createListItem("Manage account", LineAwesomeIcon.USER_CIRCLE, MaintenanceView.class),
                createListItem("Sign out", LineAwesomeIcon.SIGN_OUT_ALT_SOLID, MaintenanceView.class)
        );
        ...
        Button logoutButton;
        logoutButton = new Button("Logout", event -> authContext.logout());

        add(list, hr, colorScheme, density, theme, hr, logoutButton);
    }
